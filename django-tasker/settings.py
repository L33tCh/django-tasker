"""
Django settings for django-tasker project.
...
SECRET_KEY = '=xil9ec*p8^6q23qr!rfjb3d*$(n4zxo1_e=*pb0xey^x^@*$w'
...
ROOT_URLCONF = 'django-tasker.urls'
...
WSGI_APPLICATION = 'django-tasker.wsgi.application'
